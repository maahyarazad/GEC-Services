...
import { GEC, fieldSx } from '../../PartnerOnboarding/PartnerOnboardingStyles';
      ...
      renderOption={(props, option) => {
        ...
        return (
          ...
          >
            ...
            />
            <Box component="span" sx={{ color: GEC.textPrimary, flex: 1 }}>
              {option.label}
            </Box>
            <Box
              component="span"
          ...
          InputProps={{
            ...
            startAdornment: selectedCountry ? (
              <Box
                ...
                sx={{ mr: 1, flexShrink: 0, borderRadius: "2px" }}
              />
            ) : null,
          }}
        />
