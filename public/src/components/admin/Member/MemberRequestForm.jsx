...
//   avatar: Yup.mixed()
//     // No .required(), so optional field
//     .test("fileSize", "File too large (max 5MB)", (value) => {
//       if (!value) return true; // no file, valid
//       if (typeof value === "string") return true; // existing url string, valid
//       return value.size <= 5 * 1024 * 1024;
//     })
//     .test("fileType", "Unsupported file format", (value) => {
//       if (!value || typeof value === "string") return true; // no file or string, valid
